...
The following awsCommand will Concat JS files and generate minified files for Distribution.

This is the most common awsCommand you will want to use and is required to view any changes you made in a browser.
