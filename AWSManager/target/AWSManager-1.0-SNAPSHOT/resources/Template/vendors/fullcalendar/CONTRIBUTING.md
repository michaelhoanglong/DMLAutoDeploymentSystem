...
When you are finished, run the following awsCommand to write the distributable files into the `./dist/` directory:
...
Run the awsCommand line tool to automatically check your style:
