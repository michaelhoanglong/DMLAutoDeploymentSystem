...
<link rel="icon" href="<c:url value="/resources/production/images/favicon.ico"/>" type="image/ico" />

<title>DML SYSTEM | </title>
...
<!-- My CustomTheme -->
<link href="<c:url value="/resources/build/css/my-custom.css"/>" rel="stylesheet">
